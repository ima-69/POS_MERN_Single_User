      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200/50 overflow-hidden">
          <div className="bg-gradient-to-r from-gray-50 to-white p-6 border-b border-gray-200">
            ...
            <p className="text-gray-500 mt-1">Click on any category to edit</p>
          </div>
              ...
              <tbody className="divide-y divide-gray-200">
                {categories.map(c => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700">{c.code}</td>
                    <td className="px-6 py-4 text-sm text-gray-700">{new Date(c.createdAt).toLocaleDateString()}</td>
                  </tr>
                ))}
                {categories.length === 0 && (
                  <tr>

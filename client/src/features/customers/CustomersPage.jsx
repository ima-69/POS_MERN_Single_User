            ...
            <table className="w-full">
              <thead className="bg-gray-50 sticky top-0">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">CID</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {customers.map((c) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700">{c.cid}</td>
                    <td className="px-6 py-4 text-sm text-gray-700">{c.phone}</td>
                    <td className="px-6 py-4 text-sm text-gray-700 max-w-xs truncate">{c.address}</td>
                  </tr>
                ))}
                {customers.length === 0 && (
                  <tr>
